...
smjq(document).ready(function() {
  ...
  smjq("body").append('<div id="callchuncai">召唤娜美</div>');
  //判断春菜是否处于隐藏状态
...
function eatfood(obj) {
  ...
  if (parseInt(gettimes) > parseInt(9)) {
    chuncaiSay("你是个大混蛋！！我都告诉你密令是：'刀刀亮真帅'，还一直让我吃吃吃，我正减肥呢，再见！！！");
    setFace(3);
    closechuncai_evil();
  } else if (parseInt(gettimes) > parseInt(7)) {
    chuncaiSay("............肚子要炸了，死也不要再吃了～～！！！TAT 我们聊会天吧，主人超自恋的，你输入：'刀刀亮真帅'，也许会给你礼物。");
    setFace(3);
...
function getdata(el, id) {
  ...
  var dat = {
    notice: '欢迎光临，主人暂时不在家，其实一直都不在家啦',
    'adminname': '',
    'isnotice': '',
    'ques': ['你好', '早上好', '中午好', '下午好', '晚上好', '晚安', '圣诞快乐', '刀刀亮真帅', '娜美真帅'],
    'ans': ['你好，有什么事吗？找主人的话，他不在。估计又相亲去了，记不清这是第几回了...', '早上好～', '中午好～', '下午好～', '晚上好～', '晚安～', '圣诞快乐！我家主人不在，也没有给你准备礼物（我都好久没吃零食了，肚子空空，才不把礼物给你呢(￣^￣) ！）', '谢谢夸奖，这有份648礼包送给你，支付宝口令:来一发648吧', '谢谢夸奖，这有份648礼包送给你，支付宝口令:来一发648吧'],
    'lifetime': {
      'rakutori': 1,
      'neko': 2,
      'chinese_moe': 3,
